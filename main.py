...
API_ID = int(os.environ.get("API_ID","28237821"))
API_HASH = os.environ.get("API_HASH", "0fcdcd895dd3a80e1ce6ad842c3dc01b")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8434423621:AAFzRnSOMoZsZphBVgNo-HDFeo28R31fmAQ")
